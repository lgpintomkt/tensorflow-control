...
class OptimalControlProblem():
    ...
    def _cost_function(self, coeffs):
        ...
        if ct.isctime(self.system):
            ...
            cost = self.integral_cost(inputs)
            print("Cost function: "+str(cost.numpy()))
    ...
    def compute_trajectory(
        ...
        res = tfp.optimizer.nelder_mead_minimize(
            self._cost_function,
            initial_vertex=initial_guess,
            max_iterations=tf.constant(1000)
            )
...
class OptimalControlResult(sp.optimize.OptimizeResult):
    ...
    def __init__(
        ...
        coeffs = res.position.reshape((ocp.system.ninputs, -1))
